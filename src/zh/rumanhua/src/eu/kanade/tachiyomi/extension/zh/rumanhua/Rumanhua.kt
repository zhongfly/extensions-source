...
class Rumanhua : ParsedHttpSource() {
    ...
    override fun mangaDetailsParse(document: Document): SManga = SManga.create().apply {
        title = document.selectFirst("div.book-name > .name")!!.text()
        thumbnail_url = document.selectFirst("div.thumbnail > img")!!.attr("data-src")
        author = formatAuthor(document.selectFirst("div.comic-info-detail>p:nth-of-type(2)")!!.text())
        artist = author
        description = document.selectFirst("div.cartoon-introduction>p")!!.ownText().removeSurrounding("\"")
